...
<span class="lo"><?php  echo $text; ?></span>
<div class="wrapper">
<ul class="min">
...
<div class="images">
    <div>
            <div class="my_like">
                <div class="my_count">
                <div id="like" ><button class="xxx" type="button">
                    ...
                    <div id="demo" <p id_us="<?php echo $userId; ?> " data-value="<?php $foto_id = intval($foto['id']); echo $foto_id;?> " name_user="<?php echo $name_user; ?>"></p></div>
...
<div class="comment_foto" >
    ...
    <div id="cont">
            <div class="commentin"><span class="name"><?php echo "User_name"."  :  " ?></span> <span class="com" ><?php  echo "User" ?></span></div>
    </div>
</div>
</body>
